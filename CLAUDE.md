...
## 프로젝트 개요
전 세계 AI 생태계를 뒤흔든 딥시크(DeepSeek) 연구팀이 공개한, 모든 기능이 플러그인처럼 자유롭게 결합되는 "차세대 AI 실행 조종 하네스"
초고성능 추론 모델을 내 입맛대로 확장하고 다양한 도구와 연결하여 맞춤형 슈퍼 인공지능으로 조련
전 세계 22만 개발자들이 주목하는 최신 오픈소스 AI 프론티어 기술의 심장부이자 필수 확장 플랫폼
